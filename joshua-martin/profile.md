...
- **Day-counting convention**: Joshua counts the roast date as **Day 1**, not Day 0. (Mar 29 roast → Mar 29 = Day 1, Mar 30 = Day 2, …, May 1 = Day 33.) Always verify Day N against the most recent batch-mate entries' Day numbers; do not back-derive from "today − roast date" without confirming the convention. The off-by-one error caused a Day-32 prediction set when the user was on Day 33, anchoring drift math one day too shallow.
