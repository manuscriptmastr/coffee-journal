...
- **Day 20**: Sweet spot at **5.675** (La Isabela Score 5 *"more voluminous"*, Monteblanco Score 5 Sweet Spot). Paraiso Score 4 at 5.675 (*"funky peach gummy isn't quite as developed"*) — Paraiso was the first coffee to show the batch beginning to differentiate.
- **Day 21**: The batch visibly split. All three coffees scored ≤4 at 5.7, but **in opposite extraction directions**:
  - **Pena**: mild over at 5.7 (*"nothing shining / sweetness not sugary / acidity not genuine / cocoa a little off"*) — looks like under by vocabulary, confirmed as over by tiebreaker brew at 5.675 which came out Score 3 with mouth rubbing + heavy cocoa. Pena wants **5.725+**.
  - **La Isabela**: genuinely under at 5.7 (Score 3, *"watery / hollow / little substance or development"*). Step back to **5.675** (last Score 5).
  - **Paraiso**: truly ambiguous — *"unfocused / dulled / missing crisp/bright/sweet edge and definition"* with no mouthfeel issue. No tiebreaker yet; could be either side.
...
| Hydrangea (most recent batch)  | ~0.008 → 0.030 | Pre-Day-15 CO2 phase very slow; **post-Day-15 ~0.030/day** through Day 20. **Per-coffee divergence begins Day 20–21** — Pena trending ~0.025–0.030/day, La Isabela plateauing near 5.675, Paraiso ambiguous. Single-cadence dosing breaks down here.       |
