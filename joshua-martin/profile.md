...
- **Paix**: Lasso Mejorado (historical, Orea era), and a recent set — Blue Strudel (natural Ethiopian), Blossom Wine (double-ferment washed Ethiopian), Amber Drop, Floral Standard (Andres Martinez washed Gesha, Cauca, Colombia). **Roast dates**: Blue Strudel / Blossom Wine / Amber Drop = **Apr 17 2026**; Floral Standard = **Apr 21 2026** (4 calendar days later, confirmed by maintainer 2026-05-17). **First Score-5 anchors landed at Day 19–21** (Floral Standard D19 @ 6.00, D21 @ 6.025; Amber Drop D21 @ 5.80 in corrected day numbers). The "rest-window minimum" hypothesis (§11) is now confirmed at the early bound: the under-rested signature cleared by Day 18–21, and the coffees become readable.
...
- **Per-coffee SS-center fan-out is real (~0.29 grind units across batch at D25)**, refit through D30 anchors with per-coffee slopes:

  | Coffee          | Slope  | Pred. SS @ D25 | Offset vs. AD |
  | --------------- | ------ | -------------- | ------------- |
  | Amber Drop      | 0.073  | 6.07           | 0 (finest)    |
  | Blue Strudel    | 0.062  | 6.13           | +0.06         |
  | Blossom Wine    | 0.068  | 6.14           | +0.07         |
  | Floral Standard | 0.063  | 6.36           | +0.29 (coarsest) |

  **Ordering update (2026-05-17 roast-date correction)**: The 3-coffee group (Blue, Blossom, AD) was previously fit against an Apr 18 roast date; the true roast is **Apr 17**, so all "Day N" labels for these three were one too low in the earlier fits. Slopes unchanged (invariant to a constant day shift), intercepts re-baselined finer by one slope-unit each. FS unchanged (roast Apr 21 confirmed). The equal-days-from-roast fan-out widened from ~0.18 → ~0.29 at D25 because AD/Blue/Blossom shifted finer while FS stayed put — but this comparison is somewhat artificial because the four coffees are never at the same days-from-roast on the same calendar day (FS lags the others by 4 calendar days). The **same-calendar-day spread is smaller** (e.g., May 16: AD D29 6.40, Blue D29 6.45, Blossom D29 6.50, FS D25 6.35 — a ~0.15 spread, since FS being younger pulls its setting finer). Blue Strudel and Blossom Wine still middle-pack within ~0.01 of each other at equal days-from-roast.
...
- **Blossom Wine confirmed roast-side defect, not extraction-side.** Its grind trajectory tracks the rest of the batch (slope 0.068/day, intercept +0.07 from Amber Drop at equal days-from-roast) — i.e. the **drift curve is well-formed and parallel to siblings** — but the flavor ceiling caps at Score 3. If the off-tastes ("gross/green/roasty/silty/metallic") were extraction-driven, grind changes would shift them in a directional way; instead they persist across 0.50 grind units while the cup follows the same drift curve as its siblings. **D30 6.50 → S3 ("least revolting, soft+expansive, drinkable") is the cleanest Blossom Wine cup in the dataset.** **Practical implication**: future Blossom Wine lots can be predicted from the batch curve at the +0.07 offset, but expect S3 cups regardless of grind precision. The defect is not randomizing the trajectory; it's just lowering the ceiling.
- **Sweet-spot predictions (per-coffee slopes, refit through D30, roast-date-corrected)**:

  | Day | Amber Drop (m=0.073) | Blue Strudel (m=0.062) | Blossom Wine (m=0.068) | Floral Standard (m=0.063) |
  | --- | -------------------- | ---------------------- | ---------------------- | ------------------------- |
  | 20  | 5.71                 | 5.82                   | 5.80                   | 6.04                      |
  | 25  | 6.07                 | 6.13                   | 6.14                   | 6.36                      |
  | 30  | 6.44                 | 6.44                   | 6.48                   | 6.67                      |

  **D30 convergence**: Amber Drop and Blue Strudel converge at ~6.44 by Day 30 as Blue's flatter slope crosses AD's steeper one — Blossom Wine sits just coarser. Empirical anchor checks (roast-date-corrected): Amber Drop S5 @ D21 was 5.80 (pred 5.78, +0.02); Floral Standard S5 @ D19 was 6.00 (pred 5.98, +0.02); Floral Standard S5 @ D21 was 6.025 (pred 6.10, −0.08, within 1 click); Blue Strudel D30 6.45 (pred 6.44, +0.01); Amber Drop D30 6.40 (pred 6.44, −0.04); Blossom Wine D30 6.50 (pred 6.48, +0.02). All within one grinder click of model predictions.
...
| Paix                           | **~0.067** (n=24, per-coffee avg through D30) | Blue Strudel, Blossom Wine, Amber Drop, Floral Standard. **Drift rate is ~2× the H&S/Hydrangea pre-acceleration norm**, faster than any other current roaster. Per-coffee slopes (refit through D30): AD 0.073 (n=9), FS 0.063 (n=6), Blue 0.062 (n=4, retired the inflated n=3 0.081 fit), Blossom 0.068 (n=5). **Per-coffee SS fan-out at equal days-from-roast (~0.29 at D25)**: Amber Drop finest (6.07), Blue Strudel (6.13), Blossom Wine (6.14), Floral Standard coarsest (6.36). Same-calendar-day spread is smaller (~0.15) because FS lags the 3-coffee group by 4 calendar days. Predict each Paix coffee from its own slope + intercept; do not pool. Blossom Wine confirmed roast-side defect (trajectory tracks batch, ceiling caps at S3; D30 6.50 cleanest descriptor). 3-coffee group roast date corrected from Apr 18 → Apr 17 on 2026-05-17 (intercepts re-baselined; slopes unchanged). |
...
- **Paix Day 10–14 under-rested signature** (Blue Strudel Day 10 Score 3 @ 5.50/211°F, Blossom Wine Day 11 Score 2 @ 5.60/211°F, Amber Drop Day 12 Score 4 @ 5.50/205°F, Floral Standard washed Gesha Day 14 Score 2 @ 5.525/211°F): **Four consecutive Paix coffees across two distinct origins (Ethiopian and Colombian) and four distinct processes (natural, double-ferment washed Ethiopian, [Amber Drop process], washed Gesha) all read as under-developed in the first two weeks off roast.** The signature comes in two related variants:
  ...
  - **Updated lesson hierarchy**:
    ...
    3. **D18+**: stable extraction; calibrate to Paix's actual drift curve (per-coffee 0.062–0.073/day, ~2× other roasters). Three Score-5 anchors confirmed: Floral Standard D19 @ 6.00, Amber Drop journal-D20 / corrected-D21 @ 5.80, Floral Standard D21 @ 6.025. **Use the §7 per-coffee slope+intercept table for prediction** — Amber Drop and Floral Standard are at opposite extremes of the batch (~0.29 grind units apart at equal days-from-roast D25), so transposing from one to the other fails. Predict each coffee from its own per-coffee slope + intercept.
    4. **D20–30 extended trajectory**: Per-coffee fan-out is stable across the entire post-rest range. Floral Standard's SS sits around 6.00–6.20 (D19–23) drifting to ~6.36 by D25 (D25 miss at 6.35 read S3 coarse-edge); Amber Drop's around 5.80 (corrected D21) drifting through 6.05–6.40 (D23–30, corrected day numbers), with the bean staying legible across a wide window; Blue Strudel's S4 anchors at corrected D23 6.05, D25 6.075, D29 6.40, D30 6.45 — refit slope 0.062/day pulled the per-coffee curve in line with FS and the batch average; Blossom Wine never finds an S4 — **confirmed roast-side defect**: its drift curve parallels the batch at +0.07 from Amber Drop, but flavor ceiling caps at S3 (cleanest descriptor D30 6.50: "least revolting, soft+expansive, drinkable").

#### Paix coffees — current dataset (Day vs. Score, n=38)

Extended through Day 29 (3-coffee group) / Day 25 (FS). **Note on Day labels (2026-05-17 correction)**: the table below uses the Day-N labels exactly as recorded in the journal, where the 3-coffee group (AD/Blue/Blossom) was assigned roast date Apr 18 in earlier sessions. The corrected roast date is **Apr 17**, so every Day-N label below for AD/Blue/Blossom is one too low in absolute days-from-roast terms. FS labels (roast Apr 21) are correct. The per-coffee slope+intercept fits in §7 and below have been re-baselined to the corrected roast date. Three Score-5 anchors confirmed (Amber Drop labeled D20 = corrected D21 @ 5.80; Floral Standard D19 @ 6.00 and D21 @ 6.025), confirming the rest-window minimum at Day 18–21. Blossom Wine continues to fail (peak S3) — **confirmed roast-side defect**: trajectory tracks the batch curve at +0.07 offset from Amber Drop (corrected intercept), but flavor ceiling caps at S3 regardless of grind. Empirical Paix drift is **per-coffee 0.062–0.073/day** (refit through D30; see §7 and §8); per-coffee SS fan-out spans ~0.29 grind units at equal days-from-roast (~0.15 at equal calendar days, because FS lags by 4 days).
...
```mermaid
xychart-beta
    title "Paix coffees: Score by Day off roast (n=38 through Day 29)"
    x-axis "Day off roast" 8 --> 30
    y-axis "Score" 1 --> 5
    line [3, 2, 4, 2, 4, 3, 3, 3, 1, 4, 5, 3, 5, 2, 3, 3, 4, 4, 5, 3, 4, 4, 3, 3, 4, 4, 3, 4, 4, 3, 3, 4, 3, 4, 4, 3, 2, 4, 4, 3, 3, 4, 4]
```

_Note: chart line array length (43) exceeds table row count (38) because some Day-21 entries duplicate the same coffee — kept faithful to journal order. Three Score-5 cups land between Day 19–21, confirming the under-rested signature clears by Day 18–20._

**Per-coffee individual fits (refit through D29):**

| Coffee          | Slope  | Intercept | Pred. SS @ D20 | Pred. SS @ D25 | Pred. SS @ D30 | n |
| --------------- | ------ | --------- | -------------- | -------------- | -------------- | - |
| Amber Drop      | 0.073  | 4.247     | 5.71           | 6.07           | 6.44           | 9 |
| Blue Strudel    | 0.062  | 4.575     | 5.82           | 6.13           | 6.44           | 4 |
| Blossom Wine    | 0.068  | 4.442     | 5.80           | 6.14           | 6.48           | 5 |
| Floral Standard | 0.063  | 4.78      | 6.04           | 6.36           | 6.67           | 6 |

All recent anchors within one grinder click of model predictions. **Empirical Paix per-coffee slope range 0.062–0.073 — roughly 2× faster than any other current roaster.** Blue Strudel's slope fell from 0.081 (n=3) to 0.062 (n=4) after D28/D29 anchors, confirming the §7 rule that n<4 per-coffee fits should defer to the pooled rate. **Intercepts re-baselined 2026-05-17** after the 3-coffee group's roast date corrected from Apr 18 → Apr 17 (slopes unchanged; intercepts each finer by one slope-unit).
...
- **Blossom Wine confirmed roast-side defect.** Across 9 cups Day 11–30 spanning 0.90 grind units, peak score is S3 — but the trajectory parallels the rest of the batch with slope 0.068/day. The off-tastes ("gross/green/roasty/silty/metallic") persist regardless of grind direction; the cup follows the same drift curve as its siblings but with a capped ceiling. **D30 6.50 → S3 "least revolting, soft+expansive, drinkable" is the cleanest descriptor in the Blossom Wine dataset.** Intercept offset at equal days-from-roast is +0.07 from AD. Predict future Blossom Wine grind from batch curve; do not expect to find an SS by grind adjustment alone.
- **Blue Strudel has the narrowest productive window — but tracks the drift (n=4 refit retired the inflated n=3 slope).** Early S4 cups land at D22 @ 6.05 and D24 @ 6.075 (one click apart); D28 @ 6.40 and D29 @ 6.45 added two new S4 anchors at the coarse end. The n=4 refit gives slope **0.062/day** (down from the n=3 estimate of 0.081), in line with FS and the pooled batch rate. The D26 underextraction probe at 6.50 confirmed the bean tolerates large coarse-side excursions with surprisingly little punishment (raspberry compote zingy and tart-sweet-crisp).
- **Amber Drop and Floral Standard share window-width and flavor-legibility, NOT SS-center.** They sit at the **opposite extremes** of the per-coffee SS fan-out (AD finest 6.07 at D25, FS coarsest 6.36 at D25, ~0.29 apart at equal days-from-roast). The intuition that they're "similar" reflects their reachability (multiple S4–S5 anchors, wide productive windows of 0.20–0.35 grind units, identifiable tasting notes) rather than their dial-in setting.
- **Per-coffee SS ordering at equal days-from-roast (D25, finest → coarsest): Amber Drop (6.07), Blue Strudel (6.13), Blossom Wine (6.14), Floral Standard (6.36).** Spread ~0.29 grind units. Same-calendar-day spread is smaller (~0.15) because FS lags the 3-coffee group by 4 calendar days. **Roast-date correction (2026-05-17)**: the 3-coffee group's roast date was corrected from Apr 18 → Apr 17, re-baselining their intercepts finer by one slope-unit each; FS unchanged. Slopes are invariant to a constant day shift.
...
- **Roast-date back-derivation can be off by one — verify with the maintainer when stakes are high.** Paix 3-coffee-group roast date was back-derived as Apr 18 during a 2026-05-16 session (from sibling Day labels and an assumed today date). On 2026-05-17, the maintainer confirmed the true roast date is **Apr 17** — every prior Day-N label for AD/Blue/Blossom was one too low. Slopes are invariant to a constant day shift (so the drift-rate work was unaffected), but **intercepts were finer by one slope-unit** until corrected. **Lesson**: when no explicit roast-date record exists in profile.md, treat back-derived dates as ±1 day uncertain and either (a) confirm with the maintainer before committing the dataset, or (b) record the back-derivation method and the ambiguity flag so future agents know to re-verify. Don't compound a possibly-wrong roast date across multiple sessions of intercept fitting.
