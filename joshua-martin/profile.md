...
- **Paix**: Lasso Mejorado (historical, Orea era), and a recent set — Blue Strudel (natural Ethiopian), Blossom Wine (double-ferment washed Ethiopian), Amber Drop, Floral Standard (Andres Martinez washed Gesha, Cauca, Colombia). **First Score-5 anchors landed at Day 19–21** (Floral Standard D19 @ 6.00, D21 @ 6.025; Amber Drop D20 @ 5.80). The "rest-window minimum" hypothesis (§11) is now confirmed at the early bound: the under-rested signature cleared by Day 18–20, and the coffees become readable.
...
- **Blossom Wine confirmed roast-side defect.** Across 9 cups Day 11–29 spanning 0.90 grind units, peak score is S3 — but the trajectory parallels the rest of the batch with slope 0.068/day. The off-tastes ("gross/green/roasty/silty/metallic") persist regardless of grind direction; the cup follows the same drift curve as its siblings but with a capped ceiling. **D29 6.50 → S3 "least revolting, soft+expansive, drinkable" is the cleanest descriptor in the Blossom Wine dataset** — coarse-edge headroom is more generous than the original intercept (+0.07 from AD) suggested; refit intercept is +0.06. Predict future Blossom Wine grind from batch curve; do not expect to find an SS by grind adjustment alone.
