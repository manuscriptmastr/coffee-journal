...
```mermaid
xychart-beta
    title "Paix coffees: Score by Day off roast (n=40 through Day 30)"
    x-axis "Day off roast" 8 --> 31
    y-axis "Score" 1 --> 5
    line [3, 2, 4, 2, 4, 3, 3, 3, 1, 4, 5, 3, 5, 2, 3, 3, 4, 4, 5, 3, 4, 4, 3, 3, 4, 4, 3, 4, 4, 3, 3, 4, 3, 4, 4, 3, 2, 4, 4, 3, 3, 4, 4, 3, 4]
```

_Note: chart line array length (45) exceeds table row count (40) because some Day-21 entries duplicate the same coffee — kept faithful to journal order. Three Score-5 cups land between Day 19–21, confirming the under-rested signature clears by Day 18–20._
