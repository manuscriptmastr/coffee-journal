...
- **Most recent batch** (Pena washed, La Isabela natural, Paraiso thermal shock, Monteblanco co-ferment, all roasted ~March 29): **two-regime drift across Day 9–36**. Pre-Day-27 segment runs ~0.026/day; post-Day-27 segment accelerates to ~0.033/day. The post-27 rate was first estimated at +0.0375/day from a single Day 31→33 window (the cleanest cross-coffee falsification of single-trend at the time), but extended Day-34–36 data refines it down: Day 27→36 averages **+0.033/day** ((6.20 − 5.90) / 9). The +0.038 estimate was a noise-amplified 2-day window. Single-line fit across all 38+ Score-5 anchors gives grind ≈ 0.0312·day + 5.083 (residuals widen to ±0.10 in the late-life segment vs. ±0.06 pre-Day-27). For prediction past Day 27, **use 0.033/day**, not the pooled rate and not the earlier +0.038 estimate.

```mermaid
xychart-beta
    title "Hydrangea current batch — Score-5 anchors vs day age (Z brewer)"
    x-axis "Day age" 8 --> 36
    y-axis "Grind setting" 5.30 --> 6.25
    line [5.332, 5.363, 5.395, 5.426, 5.457, 5.488, 5.519, 5.550, 5.582, 5.613, 5.644, 5.675, 5.706, 5.738, 5.769, 5.800, 5.831, 5.862, 5.894, 5.925, 5.956, 5.987, 6.018, 6.050, 6.081, 6.112, 6.143, 6.174, 6.206]
```

_Line shows pooled OLS fit (grind ≈ 0.0312·day + 5.083) across Day 8–36. Score-5 anchors (n=38+): D9 5.45, D10 5.45, D11 5.475, D13 5.50, D14 5.50, D15 5.525, D16 5.55, D17 5.575×2, D18 5.60×4, D19 5.625, D19 5.65×2, D20 5.675×2, D24 5.825, D25 5.85, D26 5.875×3, D27 5.90×3, D28 5.95, D29 5.975, D30 6.00, D30 6.025, D31 6.05×2, D33 6.125×2 (+ Paraiso correction), D34 6.15 (+ La Isabela correction), D36 6.20×2 (Monteblanco, Pena). Pooled fit splits the difference between two regimes: pre-Day-27 ~0.026/day, post-Day-27 ~0.033/day._
...
- **Sweet-spot anchors along the trend**:
  ...
  - **Day 36 (sibling SS confirmed at 6.20)**: Monteblanco 6.20 → S5 ("lovely sweet cup, flavors melded, easy to drink"); Pena 6.20 → S5 ("decadent yet focused, sugary tea, English breakfast with sugar and cream, less eucalyptus, more cocoa, more tea complexity — best cup of this version"). Two siblings hit S5 at the *same* setting that scored S4 across three sibling coffees yesterday. Three lessons: (a) the Day-35 "lean 6.175" cluster was a one-day stalled-drift wobble, not a real center shift — second clean prototype of the §11 stalled-drift false alarm pattern (after the Day-21 case); (b) Pena's narrower-window concern from Day 32–33 is **not** a per-coffee center bias — Pena tracks Monteblanco's center precisely when given the right setting; (c) Day 27→36 cross-day drift averages (6.20 − 5.90)/9 = **+0.033/day**, refining the post-Day-27 regime down from the earlier +0.038 estimate.
...
| Hydrangea (most recent batch)  | ~0.026 (Day 9–27), accelerates to ~0.033 (Day 27+) | Pena, La Isabela, Monteblanco, Paraiso. **Two-regime drift** confirmed across Day 27–36. Initial +0.038/day estimate from a Day 31→33 jump has been refined down by Day 34–36 data: Day 27→36 averages (6.20 − 5.90) / 9 = **+0.033/day**. Day 36 sibling SS at 6.20 (Monteblanco + Pena both S5) confirms all three remaining coffees track the same trend; the Day-35 4-coffee S4 cluster at 6.20 with overlapping "lean 6.175" vocabulary was a one-day stalled-drift wobble, not a real center shift (second clean prototype of the §11 false-alarm pattern after Day 21). Pooled linear fit across 38+ Score-5 anchors: grind ≈ 0.0312·day + 5.083; per-coffee differences are vocabulary-at-the-edges only (see §13). **Pena late-life note (Day 27–36)**: the Day-32→33 narrative read Pena's window as narrower than its siblings'; Day 36 S5 at the same 6.20 setting as Monteblanco contradicts the "narrower window means different center" reading — Pena tracks Monteblanco precisely when given the right setting. **Use 0.033/day for predictions past Day 27** (not the earlier +0.038 estimate, and not the pooled rate). See §7. |
...
- **Hydrangea late-life acceleration regime (Day 27+)**: The pre-Day-27 fit ran ~0.026/day with residuals inside ±0.06. Past Day 27, the trend accelerates. Initial estimate from Day 31→33 was +0.038/day, but Day 34–36 data refines this down: Day 27→36 averages **+0.033/day** ((6.20 − 5.90) / 9). The +0.038 came from a 2-day jump (Day 31→33) that turned out to be a noise-amplified upper-bound, not the true regime rate. Day 36 sibling SS at 6.20 (Monteblanco + Pena both S5) is the cleanest extended confirmation. Bracket with +2-step (0.050) jumps when conservative +1-step settings fail. Matches the late-life acceleration patterns in H&S batch 1 (past Day 50) and H&S batch 3 (past Day 58), though at a slightly milder slope.
...
- Hydrangea current batch: **two-regime drift confirmed** through Day 36. Pre-Day-27 ~0.026/day; post-Day-27 **~0.033/day** (refined down from the initial +0.038/day estimate after Day 34–36 data revealed the +0.038 was a noise-amplified 2-day window). Day 36 sibling SS at 6.20 (Monteblanco + Pena both S5) is the cleanest extended confirmation. The Day-35 4-coffee S4 cluster at 6.20 with overlapping "lean 6.175" vocabulary was a stalled-drift false alarm (second clean prototype of the §11 pattern after Day 21). Pena's Day 27→32 S4-string was tracking the accelerated trend, not aging out — confirmed by Day 33 S5 at 6.125 then Day 36 S5 at 6.20 with no mixed-edge or window-narrowing tells. **For prediction past Day 27, use 0.033/day and bracket with +2-step jumps when +1-step fails.** Matches H&S batch 1 (past Day 50) and H&S batch 3 (past Day 58) acceleration patterns at slightly milder slope.
