...
- **Stratify confidence by signal alignment.** A high-confidence prediction needs: (1) multi-anchor own-slope stability, (2) sibling-slope corroboration, (3) a maintainer-authored self-call as the freshest anchor, (4) no chronic anchor-lag pattern requiring bias correction. When all four align, predictions land within ±0.025 of true SS. When any one is missing or noisy, expect ±0.025–0.05 miss; flag the prediction as low-confidence rather than treating it like the all-aligned case.
