...
- **Paix**: Lasso Mejorado (historical, Orea era), and a recent set — Blue Strudel (natural Ethiopian), Blossom Wine (double-ferment washed Ethiopian), Amber Drop, Floral Standard (Andres Martinez washed Gesha, Cauca, Colombia). **Roast dates** (confirmed by maintainer 2026-05-17): Blue Strudel / Blossom Wine / Amber Drop = **Apr 17 2026**; Floral Standard = **Apr 21 2026** (4 calendar days later). **First Score-5 anchors landed at Day 19–21** (Floral Standard D19 @ 6.00, D21 @ 6.025; Amber Drop D20 @ 5.80). The "rest-window minimum" hypothesis (§11) is now confirmed at the early bound: the under-rested signature cleared by Day 18–20, and the coffees become readable.
- **Paix drift rate is per-coffee 0.062–0.073/day — among the fastest in the journal**, roughly 2× the H&S/Hydrangea pre-acceleration rate (~0.026–0.030) and even faster than Hydrangea's late-life accelerated regime (~0.035). Empirical fits across the full Day 16–29 dataset (n=24 Score-4+ anchors, Blossom Wine peak-S3 included):
  - **Pooled parallel-slopes model (legacy n=21 fit)**: 0.071/day. Used when per-coffee n < 4.
  - **Per-coffee individual fits (refit through D29, n=38)**: Amber Drop 0.073 (n=9), Floral Standard 0.063 (n=6), Blue Strudel 0.062 (n=4, after D28/D29 anchors retired the inflated 0.081 n=3 fit), Blossom Wine 0.068 (n=5, peak-S3 trajectory).
  - **Predict per-coffee with per-coffee slope when n ≥ 4.** Floral Standard's 0.063/day was confirmed by the D25 6.35 miss (2026-05-16): using the pooled 0.071/day landed +0.04 too coarse, while the per-coffee 0.063 would have given 6.275–6.33 (correct). All four Paix coffees now meet the n ≥ 4 threshold; pooled rate is a fallback for new coffees only.
...
- **Per-coffee SS-center fan-out is real (~0.18 grind units across batch at D25)**, refit through D29 anchors with per-coffee slopes:

  | Coffee          | Slope  | Pred. SS @ D25 | Offset vs. AD |
  | --------------- | ------ | -------------- | ------------- |
  | Amber Drop      | 0.073  | 6.15           | 0 (finest)    |
  | Blue Strudel    | 0.062  | 6.19           | +0.04         |
  | Blossom Wine    | 0.068  | 6.21           | +0.06         |
  | Floral Standard | 0.063  | 6.33           | +0.18 (coarsest) |

  **Ordering update (2026-05-16 refit)**: Blue Strudel and Blossom Wine swapped positions in the fan-out after D28/D29 anchors retired Blue's inflated n=3 slope (0.081 → 0.062). Both sit in the middle pack within ~0.02 of each other at D25; the original "Blossom Wine finer than Blue" claim came from the n=3 era and was an artifact. Amber Drop remains the finest, Floral Standard the coarsest — those two extremes are stable.

  **The intuition "Amber Drop and Floral Standard are similar"** (vocabulary class, window width, both producing legible cups across 0.20+ of grind range) does **not** translate to SS-center proximity — they sit at opposite extremes of the batch. **Predict each Paix coffee from its own slope + intercept**; do not pool sibling settings naively.
- **"Similar" appears to mean window width + flavor legibility, not SS-center alignment.** Amber Drop scored S4 at every brew from D23→D29 across 6.05→6.40 (0.35 wide); Floral Standard scored S4–S5 across D19→D23 from 6.00→6.20 (0.20 wide). Blue Strudel scored S4 at D22 6.05, D24 6.075, D28 6.40, D29 6.45 (multi-cluster window). Blossom Wine never scored S4 at any setting across 0.50 of grind range (D11 5.60 → D29 6.50). The two wide-window coffees (Amber Drop, Floral Standard) feel similar because they're forgiving and legible; the two narrow-window coffees (Blue Strudel, Blossom Wine) feel similar because they're punishing and vague — but neither pair shares an SS-center.
- **Blossom Wine confirmed roast-side defect, not extraction-side.** Its grind trajectory tracks the rest of the batch (slope 0.068/day, intercept +0.06 from Amber Drop after refit) — i.e. the **drift curve is well-formed and parallel to siblings** — but the flavor ceiling caps at Score 3. If the off-tastes ("gross/green/roasty/silty/metallic") were extraction-driven, grind changes would shift them in a directional way; instead they persist across 0.50 grind units while the cup follows the same drift curve as its siblings. **D29 6.50 → S3 ("least revolting, soft+expansive, drinkable") is the cleanest Blossom Wine cup in the dataset** — defect ceiling holds at S3, but the coarse-edge headroom is more generous than the prior parallel-slopes intercept (+0.07 from AD) suggested. **Practical implication**: future Blossom Wine lots can be predicted from the batch curve at the +0.06 offset, but expect S3 cups regardless of grind precision. The defect is not randomizing the trajectory; it's just lowering the ceiling.
- **Sweet-spot predictions (per-coffee slopes, refit through D29)**:

  | Day | Amber Drop (m=0.073) | Blue Strudel (m=0.062) | Blossom Wine (m=0.068) | Floral Standard (m=0.063) |
  | --- | -------------------- | ---------------------- | ---------------------- | ------------------------- |
  | 20  | 5.78                 | 5.88                   | 5.85                   | 5.98                      |
  | 25  | 6.15                 | 6.19                   | 6.21                   | 6.33                      |
  | 30  | 6.51                 | 6.50                   | 6.57                   | 6.69                      |

  **D30 convergence**: Amber Drop and Blue Strudel converge at ~6.50 by Day 30 as Blue's flatter slope crosses AD's steeper one. Empirical anchor checks: Amber Drop S5 @ D20 was 5.80 (pred 5.78, +0.02); Floral Standard S5 @ D19 was 6.00 (pred 5.91, +0.09); Floral Standard S5 @ D21 was 6.025 (pred 6.05, −0.03); Blue Strudel D29 6.45 (pred 6.44, +0.01); Amber Drop D29 6.40 (pred 6.44, −0.04). All within one grinder click of model predictions.
...
- **Paix Day 10–14 under-rested signature** (Blue Strudel Day 10 Score 3 @ 5.50/211°F, Blossom Wine Day 11 Score 2 @ 5.60/211°F, Amber Drop Day 12 Score 4 @ 5.50/205°F, Floral Standard washed Gesha Day 14 Score 2 @ 5.525/211°F): **Four consecutive Paix coffees across two distinct origins (Ethiopian and Colombian) and four distinct processes (natural, double-ferment washed Ethiopian, [Amber Drop process], washed Gesha) all read as under-developed in the first two weeks off roast.** The signature comes in two related variants:
  - **Variant A — metallic-roasty (Ethiopians, D10–11)**: muddy intro, "almost no flavors", zinc-like metallic finish, presents-as-underextracted. Persisted across dry aroma, wet aroma, taste, and two different waters (Harris Teeter R/O, TWW). The 205°F drop on Amber Drop muted the metallic note enough to reach Score 4 but description ("waiting for personality to kick in") suggests partial-extraction, not breakthrough.
  - **Variant B — hollow-hazy (Floral Standard, D14, washed Colombian Gesha)**: hazy, **zero sweetness**, woody/spicy surroundings, barely-citric, jasmine and tea complexity present **only in surroundings, not in the cup**. Mouth slightly abrasive/powdery and "loud". Flavors are **missing in a hollow way**, not wrong-direction. The mouth signature (small + abrasive while flavor is *absent* rather than *compressed*) is **not a spiral pattern** — it's the textbook CO₂-blocked-extraction reading where water can't reach soluble matter and disturbs surface particles instead.
  - **Roaster-wide finding**: the Ethiopian-only "double-ferment needs more rest" hypothesis no longer holds. Floral Standard is the cleanest processing class in the bag (washed) and **still under-developed at Day 14** at the predicted Hydrangea-baseline-equivalent setting. Paix's roast development is producing dense, slow-degassing beans across origin/process — the rest-window minimum is roaster-side, not bean-side. Per AGENT_GUIDE §"Under-rested coffee" + consensus minimum rest (Rao 2023 / La Cabra ≥10d / April ≥14d / Hoffmann 2–4 weeks), Paix appears to need the upper end of that range or longer.
  - **Lesson**: when a Paix coffee reads with either the metallic-roasty or the hollow-hazy signature inside its first **~14 days** off roast — and the same shape appears across siblings, waters, processes, or origins — the intervention is **time, not grind, and probably not temperature.** Re-evaluate at **Day 18+ minimum** (revised up from prior "Day 14–18") before drawing conclusions about roast development or grind direction. Do not fit drift slope through these entries; do not let them set bean-conditional priors; **do not promote to Score-5 calibration anchors even if a cup happens to score 4.** If forced to brew under-rested, La Cabra's protocol is finer + cooler (~205 °F on the Z) + shorter contact, opposite the spiral instinct — but Amber Drop D12 suggests this only mutes the off-flavor, doesn't unlock the coffee.
  - **Open question**: zero Score-5 Paix anchors exist in the journal. Until one appears, every Paix prediction is transposed from another roaster's baseline. If Floral Standard converges into clean Gesha territory at Day 18–21, that's the first real Paix calibration anchor; if it doesn't, the rest-window finding sharpens further or another root cause (roast development, density, water mismatch) needs to be considered.
  - **Day-19 update — roast level, not rest, is the dominant variable**: Two Day-19 cups (Blue Strudel @ 5.65/211°F → S3 "clean, expansive, crisp, but flavors far off, almost a 4"; Amber Drop @ 5.60/211°F → S4 "somewhat dark, fermenty/alcoholic tinge, raisin notes, astringent finish, slightest suggestion of roastiness"). Joshua's diagnostic note on Amber Drop: **"I am getting the sense these coffees are just more developed than what I'm used to."** This recontextualizes the entire Paix dataset:
    - The metallic-roasty signature at D10–11 was **not solely** an under-rest CO₂ artifact — it was the metallic edge of a fresh + darker-than-the-journal's-calibration roast. The metallic faded by D18+ (CO₂ degassing did its job) but the **darker roast character persisted** because it's the actual roast level, not a transient rest-state artifact.
    - The Variant B "hollow-hazy" reading on Floral Standard D14 ("jasmine and tea complexity in the surroundings, not in the cup") is now best read as **a Gesha roasted past the point where its delicate floral volatiles can express in-cup** — they're sitting in the cup's headspace (surroundings) because they got driven off during longer roast development.
    - Blue Strudel D19's "flavors far off" is a light-roast-trained palate reading a slightly-darker-than-expected roast as missing the bright/floral character it would have had at lighter development. The clean/expansive texture is real and reflects cleared CO₂, but the flavor depth ceiling is set by the roast level.
    - Amber Drop D19's vocabulary (raisin, fermenty/alcoholic, astringent finish, slight roastiness) is **classic Maillard-forward / development-forward** — exactly what you'd expect from a coffee roasted past first-crack-plus-30-seconds territory that the rest of the journal is calibrated around.
  - **Implication for prediction**: **Paix predictions cannot be transposed from Hydrangea/H&S/September baselines** — those roasters land lighter on the dev curve than Paix, so a Hydrangea-equivalent grind setting lands too coarse for Paix's actual extraction needs. Paix probably wants **finer + slightly cooler** than the Hydrangea-class baseline at the same age. Empirical confirmation: Amber Drop D19 @ 5.60/211°F (one click finer than my Hydrangea-transposed 5.65 prediction) scored 4 with identifiable flavors; Blue Strudel D19 @ 5.65 (the prediction) scored 3 with "flavors far off." **One-click-finer than the Hydrangea transpose is the new working baseline for Paix.**
  - **Updated lesson hierarchy**:
    1. **D10–14**: under-rest CO₂ + darker-roast metallic signature compound. "Time, not grind" still right at this stage — but rest won't fully unlock the cup, just clear the metallic.
    2. **D15–18**: metallic clears; flavor ceiling becomes visible. Don't expect Hydrangea-style brightness; this roast has a different palette. Floral Standard D16 @ 5.70 → S4 is the first non-defective Paix reading and marks the transition.
    3. **D18+**: stable extraction; calibrate to Paix's actual drift curve (per-coffee 0.062–0.073/day, ~2× other roasters). Three Score-5 anchors confirmed: Floral Standard D19 @ 6.00, Amber Drop D20 @ 5.80, Floral Standard D21 @ 6.025. **Use the §7 per-coffee slope+intercept table for prediction** — Amber Drop and Floral Standard are at opposite extremes of the batch (~0.18 grind units apart at D25), so transposing from one to the other fails. Predict each coffee from its own per-coffee slope + intercept.
    4. **D20–29 extended trajectory**: Per-coffee fan-out is stable across the entire post-rest range. Floral Standard's SS sits around 6.00–6.20 (D19–23) drifting to ~6.36 by D25 (D25 miss at 6.35 read S3 coarse-edge); Amber Drop's around 5.80 (D20) drifting through 6.05–6.40 (D23–29), with the bean staying legible across a wide window; Blue Strudel's S4 anchors at D22 6.05, D24 6.075, D28 6.40, D29 6.45 — refit slope 0.062/day pulled the per-coffee curve in line with FS and the batch average; Blossom Wine never finds an S4 — **confirmed roast-side defect**: its drift curve parallels the batch at +0.06 from Amber Drop, but flavor ceiling caps at S3 (cleanest descriptor D29 6.50: "least revolting, soft+expansive, drinkable").

#### Paix coffees — current dataset (Day vs. Score, n=38)

Extended through Day 29. Three Score-5 anchors have landed (Amber Drop D20 @ 5.80; Floral Standard D19 @ 6.00 and D21 @ 6.025), confirming the rest-window minimum at Day 18–20. Blossom Wine continues to fail (peak S3) — **confirmed roast-side defect**: trajectory tracks the batch curve at +0.06 offset from Amber Drop (refit), but flavor ceiling caps at S3 regardless of grind. Empirical Paix drift is **per-coffee 0.062–0.073/day** (refit through D29; see §7 and §8); per-coffee SS fan-out spans ~0.18 grind units across the batch at D25.

| Day | Coffee | Grind | Temp | Score | Vocabulary class |
|-----|--------|-------|------|-------|------------------|
| 10  | Blue Strudel    | 5.50  | 211 | 3 | metallic + hollow + dark complexion |
| 11  | Blossom Wine    | 5.60  | 211 | 2 | metallic + "almost no flavors" |
| 12  | Amber Drop      | 5.50  | 205 | 4 | "balanced/clean, waiting for personality" (metallic muted by 205°F) |
| 14  | Floral Standard | 5.525 | 211 | 2 | hollow-hazy, jasmine in surroundings only, woody, abrasive |
| 16  | Floral Standard | 5.70  | 211 | 4 | jasmine note defined, orange warmth, short flavor — first non-defective Paix reading |
| 17  | Floral Standard | 5.70  | 211 | 3 | jasmine-forward, woody, hint that 5.70 was over — go coarser |
| 17  | Floral Standard | 5.75  | 211 | 3 | held-back jasmine, not much substance — still searching |
| 19  | Blue Strudel    | 5.65  | 211 | 3 | clean + expansive + crisp, "flavors far off" — metallic cleared |
| 19  | Blossom Wine    | 5.625 | 211 | 1 | gross/roasty/green — defective trajectory continues |
| 19  | Amber Drop      | 5.60  | 211 | 4 | dark fruit, raisin, fermenty/alcoholic, astringent finish, slight roastiness |
| 19  | Floral Standard | 6.00  | 211 | **5** | **first Paix S5**: citrus + jasmine + tea spice coming to life in flavor; bright gesha sweetness in cooldown |
| 20  | Blue Strudel    | 5.75  | 211 | 3 | syrupy first, slight blueberry tinge, "squarely in the middle, perhaps overextracted" |
| 20  | Amber Drop      | 5.80  | 211 | **5** | **second Paix S5**: clean raisin/rum/grape acidity, fermenty/alcoholic, good sweet+acidic cooldown |
| 20  | Blossom Wine    | 5.80  | 211 | 2 | weird green+roasty offtastes persist, silty mouthfeel — likely roast defect |
| 21  | Floral Standard | 5.75  | 211 | 3 | jasmine held back, slight citrus, not bad — overextracted from D19? |
| 21  | Blue Strudel    | 5.85  | 211 | 3 | wild raspberry/blueberry hinted; volume present but flavor not fully honest |
| 21  | Amber Drop      | 5.90  | 211 | 4 | acidity lost, alcoholic perfuminess dominates, "5.85?" |
| 21  | Floral Standard | 6.00  | 211 | 4 | flavors melded, jasmine focused, "barely conservative vs explosive — 6.025?" |
| 21  | Floral Standard | 6.025 | 211 | **5** | **third Paix S5**: thrillingly citrusy, mouthfilling, jasmine + sparkling — Joshua: "frustratingly good. Coarser." |
| 22  | Blossom Wine    | 6.00  | 211 | 3 | first non-gross Blossom Wine cup — soft, white-flowers hint, weird roasty tinge |
| 22  | Blue Strudel    | 6.05  | 211 | 4 | raspberry + perfumy side, good through cooldown |
| 23  | Amber Drop      | 6.05  | 211 | 4 | loose, large, good flavors + sweetness + interest through last sip |
| 23  | Blossom Wine    | 6.10  | 211 | 3 | florality + spice in spirit of Ethiopian, but no acidity, no flavors |
| 23  | Blue Strudel    | 6.10  | 211 | 3 | very loose, short flavor, less fruit-forward — possibly underextracted |
| 23  | Floral Standard | 6.20  | 211 | 4 | great flavors, softer side — "can this be pushed?" |
| 23  | Floral Standard | 6.15  | 211 | 4 | sharper, more potent, melded but slightly tight — "6.2 or higher?" |
| 24  | Amber Drop      | 6.10  | 211 | 3 | flavors short-lived, finish short — go finer (6.05?) |
| 24  | Blossom Wine    | 6.075 | 211 | 2 | classic overextracted Ethiopian: heavy black tea, silty/powdery mouthfeel — "needs notably coarser" |
| 24  | Blue Strudel    | 6.075 | 211 | 4 | sweet, perfumy, small volume but melded; "6.10?" |
| 25  | Amber Drop      | 6.10  | 211 | 4 | quite close, delicate, scratchy — "6.075, or wait, or significantly coarser?" |
| 26  | Blossom Wine    | 6.20  | 211 | 3 | textures and looseness here, still no real flavors but slight green/gross note — "6.30 and higher" |
| 26  | Blue Strudel    | 6.50  | 211 | 3 | **probe of underextraction ceiling** — underextracted but raspberry compote zingy and tart-sweet-crisp; far less punishing than expected |
| 26  | Amber Drop      | 6.30  | 211 | 4 | **closing lesson cup** — barely soft, needs framing, but intense/exciting/gigantic personality, tart-sweet-intense notes |
| 26  | Blue Strudel    | 6.25  | 211 | 3 | punchy but not berry-forward; "not as good as 6.5 — somewhere 6.3–6.45" |
| 27  | Amber Drop      | 6.30  | 211 | 4 | more melded/sweet, less explicit flavor, good glow — "keep one more day?" |
...
| 29  | Blossom Wine    | 6.50  | 211 | 3 | **cleanest Blossom Wine cup in dataset** — least revolting, soft+expansive texture, at least drinkable; defect ceiling holds |
| 29  | Blue Strudel    | 6.45  | 211 | 4 | more perfumy, slightly less focused flavors — mild coarse-edge tell, drift-forward tracking |
| 29  | Amber Drop      | 6.40  | 211 | 4 | very exciting cooldown, perfumy, tart, growing brightness — "perhaps not quite as focused as absolute SS" (coarse-edge of window) |
| 30  | Blossom Wine    | 6.60  | 211 | 3 | not bad, but no real flavors — defect ceiling holds; one-click coarser than D29 reduced volume |
| 26  | Floral Standard | 6.35  | 211 | 4 | somewhat straight and big, tart > jasmine/sweetness, slightly coarse all over mouth, "could still be more focused — 6.325?" |
| 30  | Blue Strudel    | 6.45  | 211 | 3 | **spiral signal at repeated D29 setting** — scratchy + powdery + lost berry flavor + sharper structured acidity + less perfumy. Same setting one day later went S4 → S3 with classic small-flavors+rough-mouthfeel compression. SS shifted finer-under-our-feet between D29 and D30; per-coffee 0.062/day slope held or accelerated, NOT flattened |

```mermaid
xychart-beta
    title "Paix coffees: Score by Day off roast (n=41 through Day 30)"
    x-axis "Day off roast" 8 --> 31
    y-axis "Score" 1 --> 5
    line [3, 2, 4, 2, 4, 3, 3, 3, 1, 4, 5, 3, 5, 2, 3, 3, 4, 4, 5, 3, 4, 4, 3, 3, 4, 4, 3, 4, 4, 3, 3, 4, 3, 4, 4, 3, 2, 4, 4, 3, 3, 4, 4, 3, 4, 3]
```

_Note: chart line array length (46) exceeds table row count (41) because some Day-21 entries duplicate the same coffee — kept faithful to journal order. Three Score-5 cups land between Day 19–21, confirming the under-rested signature clears by Day 18–20._

**Per-coffee individual fits (refit through D29):**

| Coffee          | Slope  | Intercept | Pred. SS @ D20 | Pred. SS @ D25 | Pred. SS @ D30 | n |
| --------------- | ------ | --------- | -------------- | -------------- | -------------- | - |
| Amber Drop      | 0.073  | 4.320     | 5.78           | 6.15           | 6.51           | 9 |
| Blue Strudel    | 0.062  | 4.637     | 5.88           | 6.19           | 6.50           | 4 |
| Blossom Wine    | 0.068  | 4.51      | 5.85           | 6.21           | 6.55           | 5 |
| Floral Standard | 0.063  | 4.78      | 6.04           | 6.36           | 6.67           | 6 |

All recent anchors within one grinder click of model predictions. **Empirical Paix per-coffee slope range 0.062–0.073 — roughly 2× faster than any other current roaster.** Blue Strudel's slope fell from 0.081 (n=3) to 0.062 (n=4) after D28/D29 anchors, confirming the §7 rule that n<4 per-coffee fits should defer to the pooled rate.
...
- **Blossom Wine confirmed roast-side defect.** Across 10 cups Day 11–30 spanning 1.00 grind units, peak score is S3 — but the trajectory parallels the rest of the batch with slope 0.068/day. The off-tastes ("gross/green/roasty/silty/metallic") persist regardless of grind direction; the cup follows the same drift curve as its siblings but with a capped ceiling. **D29 6.50 → S3 "least revolting, soft+expansive, drinkable" remains the cleanest descriptor**, while D30 6.60 → S3 "not bad, but no real flavors" was weaker — one-click coarser-than-drift-forward (~0.10 above D29) lost flavor volume, suggesting Blossom's productive coarse-side headroom is narrower than the D29 anchor alone implied. Predict future Blossom Wine grind from batch curve; do not expect to find an SS by grind adjustment alone.
- **Blue Strudel: D30 spiral at repeated D29 setting flips the late-life signal from "flattening" to "slope holds or accelerates."** D29 6.45 → S4 mild coarse-edge ("more perfumy, slightly less focused"). **D30 6.45 → S3 spiral** ("scratchy + powdery + lost berry flavor + sharper structured acidity + less perfumy"). Same setting, one day later, with the **classic small-flavors + rough-mouthfeel compression** — textbook spiral diagnosis (see `skills/diagnose-spiral.md`). SS shifted finer-under-our-feet between D29 and D30 by at least one click; per-coffee 0.062/day held at minimum, possibly accelerated. **Implication**: Blue D30 SS is probably **6.375–6.40**, not 6.50 — finer than the per-coffee linear model predicted. Earlier S4 anchors land at D22 @ 6.05 and D24 @ 6.075 (one click apart); D28 @ 6.40 and D29 @ 6.45 added two new S4 anchors at the coarse end. The D26 underextraction probe at 6.50 confirmed the bean tolerates large coarse-side excursions with surprisingly little punishment (raspberry compote zingy and tart-sweet-crisp). **The narrow productive window is real and SS moves daily** — drift-forward predictions need fine-side hedging at D29+.
- **Amber Drop and Floral Standard share window-width and flavor-legibility, NOT SS-center.** They sit at the **opposite extremes** of the per-coffee SS fan-out (AD finest 6.15 at D25, FS coarsest 6.33 at D25, ~0.18 apart). The intuition that they're "similar" reflects their reachability (multiple S4–S5 anchors, wide productive windows of 0.20–0.35 grind units, identifiable tasting notes) rather than their dial-in setting.
- **Per-coffee SS ordering at D25 (finest → coarsest): Amber Drop (6.15), Blue Strudel (6.19), Blossom Wine (6.21), Floral Standard (6.33).** Spread ~0.18 grind units. **Blue Strudel ↔ Blossom Wine swapped positions in the 2026-05-16 refit** — Blue's slope corrected from 0.081 → 0.062, pulling its D25 prediction finer than Blossom Wine's. Both middle-pack coffees sit within ~0.02 of each other at D25; the original "Blossom finer than Blue" claim was a n=3-fit artifact.
...
- **One-day single-click anchor spreads are noise, not bias**: A one-click difference in Score-5 setting between two sibling coffees on a single day is within bracket-corridor noise. Treating it as evidence of a per-coffee drift bias is overfitting. Require ≥2 non-adjacent days of consistent spread before promoting to a per-coffee bias. **Prototype**: Day 30 Paraiso 6.025 S5 vs. Monteblanco 6.00 S5 looked like Paraiso runs coarser; Day 33 sibling consensus at 6.125 (Monteblanco + Pena both S5, Paraiso correction also 6.125) confirmed all three coffees track the same trend.
- **Day-counting convention**: Joshua counts the roast date as **Day 0**, not Day 1. (Mar 29 roast → Mar 29 = Day 0, Mar 30 = Day 1, …, Apr 29 = Day 31, Apr 30 = Day 32, May 1 = Day 33, May 2 = Day 34.) Always verify Day N against the most recent batch-mate entries' Day numbers; do not back-derive from "today − roast date" without confirming the convention. Earlier sessions made off-by-one errors in both directions before settling on Day 0 as the convention.
- **Roast-date verification: `date` every session, and record dates explicitly in profile.md.** Multi-session day-arithmetic compounding errors are the single most expensive class of mistake an agent can make in this journal because they corrupt the intercepts (calibrated to absolute days-from-roast). Two specific failure modes observed in the 2026-05-16/17 sessions: (a) trusting the environment "today" date instead of running `date` every entry — the environment date can be stale, and a multi-turn session may cross midnight. (b) Back-deriving the roast date from sibling Day labels + an assumed today date — if the today-date is wrong, the back-derived roast date is wrong, and any "correction" that follows propagates the error. **The correct sequence is**: (1) run `date`; (2) ask the maintainer for the explicit roast date if not in profile.md; (3) compute Day N = today − roast date − convention-offset; (4) record the roast date in profile.md §7 so future sessions don't repeat the back-derivation. Slopes are invariant to a constant day shift, but **intercepts are not** — getting the roast date wrong by a day shifts every intercept by one slope-unit. **Paix-specific record**: Blue/Blossom/AD = Apr 17 2026, FS = Apr 21 2026 (recorded in §7).
- **Hydrangea late-life acceleration regime (Day 27+, batch closed at Day 37)**: The pre-Day-27 fit ran ~0.026/day with residuals inside ±0.06. Past Day 27, the trend accelerates. The post-27 rate went through three estimates as data accumulated: +0.038/day from Day 31→33 (noise-amplified 2-day window), refined down to +0.033 with Day 34–36 data, then settled at **+0.035/day** as the closing rate after Day 37 ((6.25 − 5.90)/10 = 0.035). The +0.05 jump D36→D37 and the slow D33→D34 step (+0.025) are noise wobbles around the +0.035 mean. Bracket with +2-step (0.050) jumps when conservative +1-step settings fail. Matches the late-life acceleration patterns in H&S batch 1 (past Day 50) and H&S batch 3 (past Day 58), at slightly milder slope. **Lesson for future batches**: estimating a regime rate from a 2-day window is unreliable; need ≥4 anchor-days spanning ≥6 calendar days to settle the rate within ±0.005/day.

- **Closing principle — flavor volume + underextraction ceiling + bigger increments**: Recorded as Joshua's retrospective lesson at the close of the current Paix dataset (Amber Drop Day 26 @ 6.30): _"seek flavor volume and genuine/fresh flavors above all else, and don't be afraid to find the underextraction ceiling, and work in much larger increments of 10–50 microns (0.1–0.5 on Lagom P64). It gives you so much information and the cups aren't bad at all."_ This synthesizes three lessons that recur across the journal:
  1. **Flavor volume is a primary signal**, not a secondary one. "Small flavor volume + clean mouthfeel" reliably indicates overextraction or fine-edge SS; "loose/expansive + honest flavors" reliably indicates SS or coarse-edge. Don't let descriptor matching (e.g. "I taste the tasting notes!") override the volume signal — small + on-profile is still small.
  2. **The underextraction ceiling is far more forgiving than the overextraction floor.** A coarse-side probe at 0.10–0.50 beyond the prior setting typically produces an enjoyable cup with short-lived flavors (Blue Strudel D26 @ 6.50 → S3; Amber Drop D26 @ 6.30 → S4). The same-magnitude fine-side probe routinely hits the overextraction spiral with mouth discomfort + collapsed flavors. **The information-per-brew ratio is much higher when probing coarser.**
  3. **Single-click (0.025) increments waste brews on unfamiliar coffees.** When a coffee's SS-center is unknown (new roaster, new origin, large day-gap, or post-regime-shift), use **0.05–0.10** as the default first probe and **0.025** only for fine-tuning around an established anchor. The Hydrangea Day-32→33 mixed-edge resolution required +0.050; the Paix Day-26 probe used +0.40 to reveal the bean's coarse-side tolerance in a single brew. The §10 step-size data already shows Joshua reaches for 0.05+ increments 57% of the time — this principle formalizes that practice as deliberate strategy, not improvisation.
...
- **Paix drift rate refit through D29 (n=24 Score-4+ anchors)** — see §7/§8 for the per-coffee slope+intercept table. Per-coffee slopes range 0.062–0.073/day; Blue Strudel's previously-inflated 0.081 (n=3) corrected to 0.062 (n=4) after D28/D29 anchors, retiring the prior "pending refit" question. The prior +0.0125/day estimate was a 2-day-window artifact. Open sub-questions: (a) does the per-coffee fan-out (AD finest → FS coarsest, spread ~0.18 at D25) reproduce on the next Paix purchase, suggesting roaster-side per-coffee structural differences; (b) does the per-coffee slope range hold past Day 30, or does Paix accelerate further at late ages like H&S and Hydrangea; (c) is Floral Standard's coarser intercept a Gesha-vs-other-origin effect or a per-coffee idiosyncrasy; (d) **Blue Strudel ↔ Blossom Wine middle-pack ordering** is now Blue-finer-than-Blossom by ~0.02 at D25, swapped from the n=3 era — confirm with one more D30+ anchor for each; (e) **Late-life regime — split signal across coffees**: FS D25/D26 6.35 (S3 then S4, both coarse-edge two days running) hinted at slope **flattening** (slope decreasing as bean stabilizes). But **Blue Strudel D30 6.45 → S3 spiral at the same setting that scored S4 on D29** points the **opposite direction**: SS moved finer-under-our-feet by ≥1 click in 24 hours, so the per-coffee 0.062/day slope held or **accelerated** at D30 for Blue. Two coffees, opposite late-life signals. Possible reconciliations: (i) per-coffee late-life behavior diverges by coffee (FS flattens, Blue accelerates), parallel to per-coffee slope differences D16–D27; (ii) one of the two readings is noise — Blue D30 6.45 spiral could alternatively mean SS at D30 sits between 6.40 and 6.45 (drift-forward overshot by a click), not that slope accelerated; (iii) batch-wide intercepts are ~0.05 too coarse and the apparent flattening + apparent acceleration are both intercept artifacts. Need: (a) FS D27+ anchor at 6.40 or finer; (b) Blue D31+ at 6.40 with fine-side hedge. Do **not** refit per-coffee slopes yet.
- **Blossom Wine roast-defect confirmed** (n=10, Day 11–30, peak S3 across 1.00 grind units). Trajectory parallels batch (slope 0.068/day, intercept +0.06 from Amber Drop) but ceiling caps at S3. **Cleanest cup**: D29 6.50 → S3 "least revolting, soft+expansive, drinkable"; D30 6.60 went one click past that cleaner setting and lost flavor volume. **Practical use**: predict Blossom Wine grind from batch curve at +0.06 offset; expect S3 cups regardless of grind precision. **Outstanding**: if a similar double-ferment washed Ethiopian appears in a future Paix purchase with the same off-tastes, the defect is a roaster/process signature; if not, it was lot-specific.
