...
- [`tim-hwang/`](./tim-hwang/) — Tim's journal (~1900 brews, coarser-step grinder, drift-based prediction **disabled** — see that profile's §8 for the walked-through sanity checks).
